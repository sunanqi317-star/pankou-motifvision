  ...
  return (
    <section className="project-detail-section project2-visual-evidence-section">
      ...
      <p className="project-section-description">
        Republican-era pictorial sources provide the foundation for the restoration process. This
        interactive embroidery experience reconstructs archival Pankou imagery through a layered
        digital recovery workflow, connecting historical references, visual restoration, structural
        interpretation, and craft knowledge. Each restoration stage reveals how traditional
        fastening techniques can be documented, understood, and transformed into accessible digital
