export const profile = {
  ...
  researchInterests: [
    ...
    'AIGC-Assisted Cultural Design',
  ],
} as const;

export const aboutMe = [
  'I am a Master of Design candidate at China University of Geosciences, Beijing, with a background in product design, jewelry design, and traditional material culture. I expect to graduate in June 2027 and hope to pursue PhD opportunities for 2027 entry, with a focus on digital heritage, interactive virtual museums, digital craft, and AIGC-assisted cultural design.',
  'My current work explores how traditional craft knowledge can be translated into interactive, visual, and generative experiences through design research and digital technologies.',
  'Beyond academic research, I enjoy exploring food as a way to relax and relieve stress. I also enjoy traveling, as it allows me to experience different cultures, local histories, and ways of life.',
] as const;
...
export const researchExperience: ResearchExperienceEntry[] = [
  {
    ...
    title: 'Haipai Pankou as Playable and Computable Craft Heritage',
    time: '2025 – Present',
    institution: 'China University of Geosciences, Beijing',
    ...
    methods:
      'Cultural gene database · Seven-dimensional labelling · Stable Diffusion · LoRA · Unity · Web prototype',
    outputs:
      'Research manuscript · Pankou database · Digital models · Unity/web prototype · AIGC experiments',
  },
  {
  ...
  },
  {
    ...
    title: 'Design Ethics, Playful Interaction, and Emotion-Oriented Jewelry Practice',
    time: '2025',
    institution: 'China University of Geosciences, Beijing',
    label: 'Design Ethics & Interaction',
    cardVariant: 'ethics',
    overview:
      'Explores emotion-oriented interactive jewelry through modular structure, playful interaction, and material experimentation.',
    role:
      'Concept development, interaction design, material experimentation, ethical reflection, project documentation.',
    methods:
      'Design ethics · Emotion-oriented design · Playful interaction · Modular jewelry · Material experimentation',
    outputs:
      'Interactive jewelry concept · Modular design exploration · Ethical evaluation · Project documentation',
  },
  {
